            ...
            <div class="container">
                <div class="row">
                    <div class="page-head-content">
                        <h1 class="page-title">Iniciar cadastro ou Fazer Login </h1>               
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-md-12 col-xs-12 register-blocks">
                            ...
                            <form action="" method="post">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="nome" required="required" value="<?=$objFcs->tratarCaracter((isset($func['nome']))?($func['nome']):(''), 2)?>">
                                </div>
                                <div class="form-group">
                                    <label for="email">Email</label>
                                    <input type="text" class="form-control" name="email" required="required" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" value="<?=$objFcs->tratarCaracter((isset($func['email']))?($func['email']):(''), 2)?>">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="text-center">
                                    <button type="submit" name="btCadastrar" value="Cadastrar" class="btn btn-default">Registrar</button>
                                </div>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="box-for overflow">                         
                        <div class="col-md-12 col-xs-12 login-blocks">
                            ...
                            <form action="" method="post">
                                ...
                                <div class="text-center">
                                    <button type="submit" name="btLogar" class="btn btn-default">Entrar</button>
                                </div>
                            </form>
                            <br>

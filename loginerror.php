...
<html class="no-js" lang="pt_br">
    ...
    <body>
            ...
            <div class="container">
                <div class="row">
                    <div class="page-head-content" >
                        <h1 class="page-title">Ops! Email ou senha incorretos, tente novamente! </h1>               
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="text-center">
        	<button type="submit" onclick="window.location= '/ProjetoClinica/cadastro.php'" class="btn btn-default">Voltar</button>
        </div>

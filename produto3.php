...
if($_SESSION['logado'] == "sim"){
    ...
    header("location: /ProjetoClinica/cliente/produto3.php");
                ...
                <div class="clearfix padding-top-40" >
                    <div class="col-md-8 single-property-content prp-style-1 ">
                        <div class="section property-video"> 
                                <center><h4 class="">Ração Guabi Biriba Sabor Carne</h4></center><p> 
                                <div class="video-thumb">                                   
                                        <center><img src="assets/img/property-3.jpg"></center>            
                        ...
                        <aside class="sidebar sidebar-property blog-asside-right">
                            <div class="dealer-widget">
                                <div class="dealer-content">                                    
                                        <div class="clear">
                                            <div class="col-xs-8  ">
                                                <h3 class="">
												<h1 class=""></h1>											                                                   
													<h2 color="#ccc">R$ 57,50<p></h2>
													<span>De R$ 73,50 por R$ 52,50
                                ...
                                <div class="s-property-content">
                                    <p> - Ração econômica indicada para cachorros adultos de qualquer raça.<p>
										- Sabor agradavel<p>
										- Suplementado com Omega 3 e 6
									</div>
                            </div>                            
						</aside>
                    </div>

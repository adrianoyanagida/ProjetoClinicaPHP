...
$objFcs = new Funcoes();
    ...
    if($_SESSION['logado'] == "sim"){
        ...
        header("location: /ProjetoClinica/cliente/avisoloja.php");
                        ...
                        <div class="col-md-12 col-xs-12 register-blocks text-center">
                            ...
                            <form action="" method="post">
                                <div class="form-group text-center">
                                    <label for="name">Nossa loja ainda não esta pronta, nos visite pessoalmente para adquirir nossos produtos, ou entre em contato pelo telefone!</label><br>
                                    <label for="name">Endereço: Rua dos bichos, 894 </label><br>
                                    <label for="name">Telefone: +55 016 3831-9898 </label>
                                </div>											
                            </form>      
                        <div class="text-center">
        			    	<button type="submit" onclick="window.location= '/ProjetoClinica/principal.php'" class="btn btn-default">Voltar</button>
        				</div>		                 
                    </div>
                </div>
            </div>

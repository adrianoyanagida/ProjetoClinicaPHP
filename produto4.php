...
if($_SESSION['logado'] == "sim"){
    ...
    header("location: /ProjetoClinica/cliente/produto4.php");
            ...
            <div class="container">
              ...
              <div class="collapse navbar-collapse yamm" id="navigation">
                    <div class="button navbar-right">
                        <button class="navbar-btn nav-button wow bounceInRight login" onclick=" window.open('principal.php')" data-wow-delay="0.4s">Inicio
					</button>
                    </div>
                ...
                <div class="clearfix padding-top-40" >
                    <div class="col-md-8 single-property-content prp-style-1 ">
                        <div class="section property-video"> 
                                <center><h4 class="">Coleira De Strass Para Cachorros Ou Gatos</h4></center><p> 
                                <div class="video-thumb">                                   
                                        <center><img src="assets/img/property-4.jpg"></center>            
                        ...
                        <aside class="sidebar sidebar-property blog-asside-right">
                            <div class="dealer-widget">
                                <div class="dealer-content">                                    
                                        <div class="clear">
                                            <div class="col-xs-8  ">
                                                <h3 class="">
												<h1 class=""></h1>											                                                   
													<h2 color="#ccc">R$ 39,90<p></h2>
													<span>De R$ 59.90 por R$ 32.90
													Economia de R$ 27,00</span>        
                                                </h3>
												<button class="navbar-btn nav-button wow  login" onclick="window.location= '/ProjetoClinica/avisoloja.php'">COMPRAR</button>
											</div>
										</div>
									</div>
								</div>
                                ...
                                <div class="s-property-content">
                                    <p> -Detalhes em Strass na parte externa<p>
										-Mais brilho para seu pet<p>
										-Material em couro sintético strong<p>
										- Tamanhos: (PP: 30 cm; P: 37 cm; M: 42 cm)
									</div>
                            </div>                            
						</aside>
                    </div>

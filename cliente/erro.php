...
<html class="no-js" lang="pt_br">
    ...
    <body>
            ...
            <div class="container">
                <div class="row">
                    <div class="page-head-content" >
                        <h1 class="page-title">Horário Indisponível! </h1>     
                        <br><br>
                        <h6 >Ops! Parece que este horário não esta disponível, lamentamos pelo ocorrido! </h6>           
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="text-center">
        	<button type="submit" onclick="window.location= '/ProjetoClinica/cliente/agendamento.php'" class="btn btn-default">Voltar</button>
        </div>

...
if($_SESSION['logado'] == "sim"){
    ...
    header("location: /ProjetoClinica/cliente/produto2.php");
                ...
                <div class="clearfix padding-top-40" >
                    <div class="col-md-8 single-property-content prp-style-1 ">
                        <div class="section property-video"> 
                                <center><h4 class="">Bebedouro Inteligente JetaPlast Azul</h4></center><p> 
                                <div class="video-thumb">                                   
                                        <center><img src="assets/img/property-2.jpg"></center>            
                        ...
                        <aside class="sidebar sidebar-property blog-asside-right">
                            <div class="dealer-widget">
                                <div class="dealer-content">                                    
                                        <div class="clear">
                                            <div class="col-xs-8  ">
                                                <h3 class="">
												<h1 class=""></h1>											                                                   
													<h2 color="#ccc">R$ 32,90<p></h2>
													<span>De R$ 65,80 por R$32,90
													Economia de R$ 32,00</span>        
                                                </h3>
                                ...
                                <div class="s-property-content">
                                    <p> 
									Pet: Gatos e Cachorros<p>
									Porte de Raça: Pequeno, Grande e Médio<p>
									Idade: Filhote, Sênior e Adulto<p>
									Capacidade: 2l<p>
									Material: Plástico e Acrílico<p>
									Tipo: Bebedouro<p>
									Cor: Azul
									</div>
                            </div>                            
